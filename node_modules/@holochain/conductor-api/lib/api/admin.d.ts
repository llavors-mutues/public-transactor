...
export declare type InstallAppBundleResponse = InstalledApp;
...
declare type ZomeLocation = {
    Bundled(PathBuf: any): any;
    Path(PathBuf: any): any;
    Url(String: any): any;
};
declare type ZomeManifest = {
    name: string;
    hash?: string;
} & ZomeLocation;
declare type DnaManifest = {
    name: string;
    uuid?: string;
    properties?: DnaProperties;
