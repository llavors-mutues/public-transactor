...
export class PendingOfferList extends StoreElement {
    constructor() {
        /** Public attributes */
        super(...arguments);
        /** Private properties */
        this._lastSelectedOfferHash = undefined;
        this._loading = true;
    }
    async firstUpdated() {
...
], PendingOfferList.prototype, "_lastSelectedOfferHash", void 0);
__decorate([
    property({ type: String })
], PendingOfferList.prototype, "_loading", void 0);
//# sourceMappingURL=pending-offer-list.js.map